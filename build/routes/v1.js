...
apiV1.get('/users/:usersId/recipes', _favoriteContr2.default.getUserFavorites).all('/users/:userId/recipes', _authenticator2.default.notImplemented);

// End point for users to get and set favorite recipes
apiV1.get('/users/:usersId/favorites', _favoriteContr2.default.getFavorites).post('/users/:recipeId/favorites', _favoriteContr2.default.setFavorites).delete('/users/:recipeId/favorites', _favoriteContr2.default.removeRecipeFromFavorites).all('/users/:usersId/favorites', _authenticator2.default.notImplemented);
...
apiV1.get('/users/recipes', _recipeContr2.default.getUserRecipes).all('/users/recipes', _authenticator2.default.notImplemented);

apiV1.get('/admin/users', _usersContr2.default.users);
