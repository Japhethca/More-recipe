    ...
    return (
      <div className='row '>
        <div className='profile-page center col s12 m6 offset-m3 z-depth-2'>
          ...
          <hr/>
          <div>
            <img src={require('../../../images/avatar.png')} alt="profile image" className='center profile-image' />
          ...
          <div className='profile-details'>
            <ul id="profile-page-about-details" className="collection">
                ...
                <button onClick={this.onClick.bind(this)} className='btn blue' >Edit Profile</button>
          </div>
        </div>
