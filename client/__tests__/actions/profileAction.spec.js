...
describe('GET PROFILE actions', () => {
  it('creates GET_USER_PROFILE_START and GET_USER_PROFILE ' + 
...
describe('PROFILE UPDATE actions', () => {
  it('creates UPDATE_USER_PROFILE_START and UPDATE_USER_PROFILE types when ' + 
    ...
    store.dispatch(actions.handleUpdateUserProfile(profileUpdateData)).then(() => {
      expect(store.getActions()).toEqual(expectedActions);
    });
  });

  it('creates UPDATE_USER_PROFILE_FAILED action type when an error occurs', () => {
...
describe('UPDATE USER PROFILE ACTION CREATORS', () => {
  it('should return  UPDATE_USER_PROFILE action', () => {
  ...
  it('should return  UPDATE_USER_PROFILE_START action', () => {
    const expectedActions = newProfile => (
      {
        type: types.UPDATE_USER_PROFILE_START,
        newProfile
  ...
  it('should return  UPDATE_USER_PROFILE_FAILED action', () => {
    const expectedActions = newProfile => (
      {
        type: types.UPDATE_USER_PROFILE_FAILED,
        newProfile
